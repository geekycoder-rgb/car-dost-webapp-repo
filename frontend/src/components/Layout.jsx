      ...
      <header className="bg-white border-b border-neutral-200">
        <div className="max-w-7xl mx-auto px-4 lg:px-6 py-4 flex items-center justify-between gap-4 lg:gap-8">
          <Link to="/" className="flex items-center gap-3 shrink-0" data-testid="logo-link">
            <div className="flex items-center justify-center h-28 w-28 bg-white rounded-xl shadow-sm flex-shrink-0">
              <img src="/cardostlogo.png" alt="CarDost" className="h-24 w-24 object-contain" />
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-14 grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
              <div className="flex items-center gap-3 mb-4">
                <div className="flex items-center justify-center h-24 w-24 bg-white rounded-xl shadow-sm flex-shrink-0">
                  <img src="/cardostlogo.png" alt="CarDost" className="h-20 w-20 object-contain" />
                </div>
